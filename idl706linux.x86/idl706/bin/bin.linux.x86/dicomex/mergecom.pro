...
IMPLEMENTATION_VERSION               = IDL_2.1.3_3.4.0
...
DICTIONARY_FILE                         = %IDL_DICOMEX_CFG_DIR%/mrgcom3.dct
MSG_INFO_FILE                           = %IDL_DICOMEX_CFG_DIR%/mrgcom3.msg
TEMP_FILE_DIRECTORY                     = %IDL_DICOMEX_CFG_DIR%/
