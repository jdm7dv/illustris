; $Id: //depot/idl/IDL_70/idldir/lib/bilinear.pro#2 $
;
...
;               the output array.
;
;   Note: Location points outside the bounds of the array P—that is,
...
;      dimension of P — are set equal to the value of the nearest
;      element of P.
;
