; $Id: //depot/idl/IDL_70/idldir/lib/itools/ui_widgets/cw_itoperationpreview.pro#2 $
...
@cw_iterror
    ...
    wZoomIn = WIDGET_BUTTON(wRow2, VALUE=bitmap, /BITMAP)
    wZoomLabel = WIDGET_LABEL(wRow2, VALUE='100%')
    bitmap = FILEPATH('zoom_out.bmp', SUBDIR=['resource','bitmaps'])
    wZoomOut = WIDGET_BUTTON(wRow2, VALUE=bitmap, /BITMAP)
