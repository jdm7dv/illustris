; $Id: //depot/idl/IDL_70/idldir/lib/itools/components/idlitopinsertcontour__define.pro#2 $
;
...
function IDLitopInsertContour::DoAction, oTool
    ...
    for i=0, nTarg -1 do begin
        ...
        if OBJ_VALID(oContour) then begin
            ...
            oContourLevels[0]->GetProperty,my_labelling=myLabelling
            if myLabelling then begin
                oContourLevels[0]->SetProperty,my_labelling=1
