; $Id: //depot/idl/IDL_70/idldir/lib/itools/components/idlitvisimage__define.pro#2 $
;
...
pro IDLitVisImage::_UpdateMapProjection, data, nPlanes, red, green, blue
    ...
    if (nPlanes eq 1) then begin
        ...
        isRamp = ARRAY_EQUAL(red, green) && ARRAY_EQUAL(green, blue)
        if (~isRamp) then begin
            data = [ $
                [[red[data]]], $
                [[green[data]]], $
                [[blue[data]]]]
    ...
    if (nPlanes eq 1 && isRamp) then begin
