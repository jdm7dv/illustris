; $Id: //depot/idl/IDL_70/idldir/lib/itools/components/idlitvislegendcontouritem__define.pro#2 $
;
...
;        STYLE=style, $
    ...
    ; add notifier to track changes to level colors (MY_COLOR)
...
pro IDLitVisLegendContourItem::SetProperty,  $
    ...
    IF n_elements(levelLabels) NE 0 THEN BEGIN
      ...
      IF levelLabels GT 0 THEN BEGIN
        ...
        FOR i=0,nItem-1 DO oItems[i]->SetProperty, MY_LABEL_VALUE=levelLabels-1
      ENDIF
    ENDIF
...
;                ;in the legend and this should not be overwritten.
        ...
        'MY_COLOR': begin
            oSubject->GetProperty, MY_COLOR=myColor, $
