; $Id: //depot/idl/IDL_70/idldir/lib/itools/components/idlitmanipsurfcontour__define.pro#2 $
;
...
pro IDLitManipSurfContour::_CalculateAndSetLevelValue, oWin, x, y
    ...
    self._oContourLevels[0]->GetProperty,my_labelling=myLabelling
    if myLabelling then $
        self._oContourLevels[0]->SetProperty,my_labelling=1
