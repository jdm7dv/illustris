; $Id: //depot/idl/IDL_70/idldir/lib/itools/framework/idlitobjdesc__define.pro#2 $
;
...
;   An object of the type that is described by this object.
;
function IDLitObjDesc::GetObjectInstance
...
@idlit_catch
        ...
        self._oObject = self->_InstantiateObject()
