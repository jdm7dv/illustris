; $Id: //depot/idl/IDL_70/idldir/lib/itools/framework/idlitobjdescproxy__define.pro#2 $
;
...
function IDLitObjDescProxy::GetObjectInstance

  compile_opt idl2, hidden

    oTarget = self->_GetProxyTarget()
    return, (obj_valid(oTarget) ? oTarget->GetObjectInstance() : obj_new())
end
