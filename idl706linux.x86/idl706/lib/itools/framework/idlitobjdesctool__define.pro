; $Id: //depot/idl/IDL_70/idldir/lib/itools/framework/idlitobjdesctool__define.pro#2 $
;
...
function IDLitObjDescTool::GetObjectInstance

    compile_opt idl2, hidden

    oObj = self->IDLitObjDesc::GetObjectInstance()
