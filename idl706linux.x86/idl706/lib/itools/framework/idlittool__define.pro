; $Id: //depot/idl/IDL_70/idldir/lib/itools/framework/idlittool__define.pro#2 $
;
...
pro IDLitTool::Cleanup
   ...
   self->DoOnNotify, self->GetFullIdentifier(), "SHUTDOWN",0
...
pro IDLitTool::OnSelectionChange, oWin
    ...
    ids = strarr(count)
    for i=0, count-1 do $
      ids[i] = oSel[i]->GetFullIdentifier()
