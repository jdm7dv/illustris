; $Id: //depot/idl/IDL_70/idldir/lib/itools/framework/idlitobjdescvis__define.pro#2 $
;
...
function IDLitObjDescVis::GetObjectInstance
  ;; Pragmas
  compile_opt idl2, hidden

   oObj = self->IDlitObjDescTool::GetObjectInstance()
