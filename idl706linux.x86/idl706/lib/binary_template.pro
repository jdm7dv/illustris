; $Id: //depot/idl/IDL_70/idldir/lib/binary_template.pro#2 $
;
...
wRowBase = widget_base(tlb, /row, /align_right, /grid, space=10)
(*pState).wModifyOK = widget_button(wRowBase, value=' OK ')
(*pState).wModifyCancel = widget_button(wRowBase, Value=' Cancel ')
...
wRowBase = widget_base(tlb, /row, /align_right, /grid, space=10)
wOK = widget_button(wRowBase, value=' OK ')
wCancel = widget_button(wRowBase, value=' Cancel ')
;
