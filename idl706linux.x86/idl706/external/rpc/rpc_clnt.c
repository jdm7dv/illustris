...
static char rcsid[] = "$Id: //depot/idl/IDL_70/idl_src/idl/rpc_clnt.c#2 $";
 ...
 */
   ...
   if(rpcResult != RPC_SUCCESS){
      ...
      iCmdResult = 0;
   }else if(iCmdResult == 0) /* String executed with no errors */
      iCmdResult = 1;
 ...
 */
    ...
    */
	 ...
	 /*
	  * Make sure the dynamic flag is copied over.
	  */
	 dst->flags |= src->flags & IDL_V_DYNAMIC;
 ...
 *		  data block. If the value is set to IDL_ARR_INI_ZERO
 ...
 */
   ...
   case IDL_TYP_BYTE:      
     ...
     break;
   case IDL_TYP_INT:
     vTmp->value.arr->elt_len = sizeof(IDL_INT);
     break;
   case IDL_TYP_LONG:
   ...
   case IDL_TYP_STRING:
     ...
     break;
   case IDL_TYP_UINT:
     vTmp->value.arr->elt_len = sizeof(IDL_UINT);
     break;
   case IDL_TYP_ULONG:
     vTmp->value.arr->elt_len = sizeof(IDL_ULONG);
     break;
   case IDL_TYP_LONG64:
     vTmp->value.arr->elt_len = sizeof(IDL_LONG64);
     break;
   case IDL_TYP_ULONG64:
     vTmp->value.arr->elt_len = sizeof(IDL_ULONG64);
     break;
   default:
     break;
   }
 ...
 */
   switch(type){
   case IDL_TYP_BYTE:       szElement=sizeof(UCHAR);break;
   case IDL_TYP_INT:        szElement=sizeof(IDL_INT); break;
   ...
   case IDL_TYP_UINT:       szElement=sizeof(IDL_UINT); break;
   case IDL_TYP_ULONG:      szElement=sizeof(IDL_ULONG); break;
   case IDL_TYP_LONG64:     szElement=sizeof(IDL_LONG64); break;
   case IDL_TYP_ULONG64:     szElement=sizeof(IDL_ULONG64); break;
   default:
 ...
 */
   if(pVar->flags & IDL_V_ARR){
       ...
       */
         if(pVar->value.arr->free_cb != (IDL_ARRAY_FREE_CB) 0){
