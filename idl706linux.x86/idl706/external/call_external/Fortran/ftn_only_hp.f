C
C	$Id: //depot/idl/IDL_70/idldir/external/call_external/Fortran/unix/ftn_only_hp.f#1 $
C
C NAME:
C 	ftn_only_hp.f
C
...
C	Declare a parameter that contains the temp. string length
	
	INTEGER 		CHAR_SIZE
	PARAMETER	(	CHAR_SIZE  	= 	100	)
	
C       Declare the IDL string data structure
